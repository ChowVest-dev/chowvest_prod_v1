...
import { EditPriceButton, ToggleCommodityStatus, AddCommodityButton, EditConfigButton } from "./client-components";
              ...
              <table className="w-full text-sm text-left">
                <thead className="text-xs text-muted-foreground uppercase bg-muted/50 border-b">
                  <tr>
                    ...
                    <th className="px-6 py-4 font-medium">Size / Unit</th>
                ...
                <tbody className="divide-y divide-border">
                  {commodities.map((c) => (
                    <tr key={c.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-6 py-4 font-mono text-xs text-muted-foreground">{c.sku}</td>
                      <td className="px-6 py-4 text-muted-foreground">{c.category}</td>
                      <td className="px-6 py-4 font-mono">{Number(c.size)}{c.unit}</td>

    ...
    <div className="w-full h-full flex flex-col overflow-y-auto bg-background ">
      ...
      <div className="bg-primary pt-8 pb-6 px-8 flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-primary-foreground text-xl font-bold">
             {activeScreen === "SUMMARY" ? "Delivery Details" : activeScreen === "TRACKING" ? "Live Tracking" : "Completed"}
          </h1>
          <p className="text-primary-foreground/80 text-sm mt-1">
            {activeScreen === "SUMMARY" ? "Confirm your order" : activeScreen === "TRACKING" ? "Your rider is on the way" : "Order delivered"}
          </p>
        </div>
        {activeScreen === "SUMMARY" && (
      ...
      <div className="flex-1 p-6 md:p-8 bg-muted/50">
        ...
        <div className="flex bg-background rounded-xl p-1 gap-1 mb-5 shadow-sm border border-border">
          ...
          <div className={`flex-1 text-center py-2 text-xs font-bold rounded-[9px] transition-all ${activeScreen === "TRACKING" ? "bg-primary text-primary-foreground shadow-sm" : "text-muted-foreground"}`}>
            Tracking
          </div>
